    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.CharField(help_text=b'List of authors separated by commas or <i>and</i>. Wrap with {} to prevent processing.', max_length=2048)),
                ...
                ('urldate', models.DateField(help_text=b'Date url visited', null=True, verbose_name=b'URL Date', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bibtex_required_fields', models.TextField(help_text=b'Required fields (not including title, author, year)', verbose_name=b'BibTeX required fields')),
                ('bibtex_optional_fields', models.TextField(help_text=b'Optional fields (not including title, author, year)', null=True, verbose_name=b'BibTeX optional fields', blank=True)),
        ...
        migrations.AddField(
            model_name='styletemplate',
            name='style',
            field=models.ForeignKey(to='publications.Style'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='style',
            name='bibtype',
            field=models.ManyToManyField(to='publications.Type', through='publications.StyleTemplate'),
            preserve_default=True,
        ),
        migrations.AddField(
